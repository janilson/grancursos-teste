            ...
            <v-card-text>
              <div class="layout row ma-0 align-center justify-space-between">
                <div class="text-box">
                  ...
                  <span class="grey--text">-10% <v-icon
                    small
                    color="green"
                  >trending_down</v-icon> </span>
                </div>
                <div class="chart">
                  <v-progress-circular
                    :size="60"
            ...
            <v-tabs-items v-model="selectedTab">
              ...
              <v-tab-item value="tab-2">
                <v-card>
                  <e-chart
                    :path-option="
                      [['dataset.source', dataset.monthVisit], ['series[0].type', 'line']]
                    "
                    height="350px"
                    width="100%"
                  />
...
import {
  StackData, SinData, monthVisitData, campaignData, locationData,
} from '../../api/chart';
...
export default {
  ...
  methods: {
    handleTabChange() {
      // val, e - make sure the chart resized while parent from hidden to show
